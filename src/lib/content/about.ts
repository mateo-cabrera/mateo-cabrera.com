 ...
 * 20 ans, étudiant en troisième année », deux faits qui se périment chaque
 * année — et l'historique git contient déjà un commit `fix: update age to 20`.
 * Ses deux phrases sur l'expérience utilisateur et sur « belle et performante »
 * sont conservées mot pour mot ; seule la partie datée a bougé. §3 disait
