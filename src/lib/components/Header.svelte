...
<header in:fly={{ y: 20, duration: 500 }}>
	<div class="relative mb-4 h-[150px] w-[150px] overflow-hidden rounded-full">
		<enhanced:img
			alt="Mateo Cabrera"
			class="object-cover"
			src={profileImage}
	...
	<h3 class="mb-4 flex items-center text-lg text-gray-400">
		📍 Strasbourg, France
		<svg
			...
			style="height: 1em; width: auto; vertical-align: middle; margin-left: 0.25rem;"
		>
			<path
				fill="#E1000F"
