...
import epitechLogo from '~/assets/Education/logo-epitech.png';
import graduationCapIcon from '~/assets/Education/graduation-cap-icon.svg?url';
import logoTakerAcademy from '~/assets/Education/logo-taker-academy.webp';
