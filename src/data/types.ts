...
/**
 * Une image locale, qu'Astro optimise au build (`ImageMetadata`), ou une URL
 * d'asset servie telle quelle : les `?url` des svg, des webm et des posters.
 */
export type MediaSource = string | ImageMetadata;
